...
public class Blitz extends JPanel implements Runnable{
	...
	private int ifile;
	private int ilife;
	private char bgfn[] = {'7','8','9','a','b','c','d'};
	private char fn[] = {'0','1','2','3','4','5','6'};
	
	private static String fname = "bgmusic.mp3";
	private static Blitz bgmusic = new Blitz(fname);
	
	private static final String filename_1 = "PlayerShoot.mp3";
	private static final Blitz playershoot = new Blitz(filename_1);	
	
	private static final String filename_2 = "curve.mp3";
	private static final Blitz curve = new Blitz(filename_2);
	
	private static final String filename_3 = "YouWon.mp3";
	private static final Blitz youwon = new Blitz(filename_3);	
	
	private static final String filename_4 = "dedz.mp3";
	private static final Blitz dedz = new Blitz(filename_4);
	/* End of Jaycee Music */	
...
//	private boolean down = false;
	...
	public Blitz(){
		...
		fname = "bgmusic"+bgfn[ilife]+".mp3";
		bgmusic = new Blitz(fname);
		bgmusic.play();
