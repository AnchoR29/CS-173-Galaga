...
public class FreeMode extends JPanel implements Runnable{
	...
	// Jaycee music 
	private int ifile;
	private char fn[] = {'0','1','2','3','4','5','6'};
	
	private static String fname = "bgmusic.mp3";
	private static FreeMode bgmusic = new FreeMode(fname);
	
	private static final String filename_1 = "PlayerShoot.mp3";
	private static final FreeMode playershoot = new FreeMode(filename_1);	
	
	private static final String filename_2 = "curve.mp3";
	private static final FreeMode curve = new FreeMode(filename_2);
	
	private static final String filename_3 = "YouWon.mp3";
	private static final FreeMode youwon = new FreeMode(filename_3);	
	
	private static final String filename_4 = "dedz.mp3";
	private static final FreeMode dedz = new FreeMode(filename_4);
	/* End of Jaycee Music */
	...
	//Jaycee music start
	 ...
	 private Player mp3player; 
	   // constructor that takes the name of an MP3 file
	    public FreeMode(String filename) {
